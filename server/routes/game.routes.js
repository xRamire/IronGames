...
router.get("/game/:id", (req, res) => {
    ...
    Game.findById(id)
        ...
        .catch(err => res.json({ err, errMessage: "Problem searching this game" }))
})
...
router.put("/edit/:id", (req, res) => {
    ...
    Game.findByIdAndUpdate(id, { title, description, genre, creators, imageUrl, github, date, gameUrl }, { new: true })
        .then(updatedGame => res.json(updatedGame))
        .catch(err => res.json({ err, errMessage: "Problem editing Game" }))
})
...
router.delete("/delete/:id", (req, res) => {
    ...
    Game.findByIdAndDelete(id)
        ...
        .catch(err => res.json({ err, errMessage: "Problem deleting game" }))
})
